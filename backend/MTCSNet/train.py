...
def validate(args, logger, model, dataloader):
    ...
    logger.info("F1@0.75: {} ".format(post_pred_f1_scores['F1@0.75']))
    logger.info("F1@0.9: {} ".format(post_pred_f1_scores['F1@0.9']))
    logger.info("F1@0.5:1.0:0.05: {} ".format(post_pred_f1_scores['F1@0.5:1.0:0.05']))
    if args.net_regression:
        logger.info("Post regression Results:")
        logger.info("F1@0.5: {} ".format(post_heat_f1_scores['F1@0.5']))
        logger.info("F1@0.75: {} ".format(post_heat_f1_scores['F1@0.75']))
        logger.info("F1@0.9: {} ".format(post_heat_f1_scores['F1@0.9']))
        logger.info("F1@0.5:1.0:0.05: {} ".format(post_heat_f1_scores['F1@0.5:1.0:0.05']))
    if args.net_vorloss:
        logger.info("Post voronoi Results:")
        logger.info("F1@0.5: {} ".format(post_vor_f1_scores['F1@0.5']))
        logger.info("F1@0.75: {} ".format(post_vor_f1_scores['F1@0.75']))
        logger.info("F1@0.9: {} ".format(post_vor_f1_scores['F1@0.9']))
        logger.info("F1@0.5:1.0:0.05: {} ".format(post_vor_f1_scores['F1@0.5:1.0:0.05']))
    # mIoU
    logger.info("Classification IoU Results:")
    logger.info("aAcc: {}".format(post_aAcc))
    logger.info("IoU: {}, mIoU: {}".format(post_IoU, np.mean(post_IoU)))
    logger.info("IoU: {}".format(post_IoU[1]))
    logger.info("Acc: {}, mAcc: {}".format(post_Acc, np.mean(post_Acc)))
    logger.info("Dice: {}, mDice: {}".format(post_Dice, np.mean(post_Dice)))
    logger.info("Dice: {}".format(post_Dice[1]))
    
    if args.net_vorloss:
        logger.info("Voronoi IoU Results:")
        logger.info("aAcc: {}".format(vor_post_aAcc))
        logger.info("IoU: {}, mIoU: {}".format(vor_post_IoU, np.mean(vor_post_IoU)))
        logger.info("IoU: {}".format(vor_post_IoU[1]))
        logger.info("Acc: {}, mAcc: {}".format(vor_post_Acc, np.mean(vor_post_Acc)))
