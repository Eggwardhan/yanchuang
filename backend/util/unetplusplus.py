...
class NestedUNet(nn.Module):
    ...
    def forward(self, input):
        ...
        if self.deep_supervision:
            y1, vor1, cert1, heat1, deg1 = self.final1(x0_1,input)
            y2, vor2, cert2, heat2, deg2 = self.final2(x0_2,input)
            y3, vor3, cert3, heat3, deg3 = self.final3(x0_3,input)
            y4, vor4, cert4, heat4, deg4 = self.final4(x0_4,input)
            y = y1 + y2 + y3 + y4
            ...
            y, vor, cert, heat, deg = self.final(x0_4,input)
            return y, vor, cert, heat, deg
